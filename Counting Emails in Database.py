# This application will read the mailbox data (mbox.txt) and count the number of email messages per organization (i.e. domain name
#of the email address) using a database with the following schema to maintain the counts.
